        ...
        "columns": [
            ...
            { "data": "marca.nombre" },
            {
                ...
                "render": function (data) {
                    var d = data.toFixed(2).replace(/\d(?=(\d{3})+\.)/g, '$&'); //expresion regular para convertir el precio 
                    return d;
                }                
            },
                ...
                "render": function (data) {
                    return `
                        <div class="text-center">
                            <a href="/Admin/Producto/Upsert/${data}"class="btn btn-success text-withe" style="cursor:pointer">
